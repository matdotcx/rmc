"""Playlist view screen for the TUI."""
...
class PlaylistScreen(Screen):
    ...
    def _load_tracks(self) -> None:
        """Load tracks from the playlist in background thread."""
        try:
            tracks = self.app.music_controller.get_playlist_tracks(self.playlist_name)
