"""Artist view screen for the TUI."""
...
class ArtistScreen(Screen):
    ...
    def _load_tracks(self) -> None:
        """Load tracks by the artist in background thread."""
        try:
            tracks = self.app.music_controller.get_tracks_by_artist(self.artist_name)
